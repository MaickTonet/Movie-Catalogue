...
export default function MovieOverview({ movie }: { movie: Movie }) {
	...
	return (
		<section className={'flex flex-col gap-3 justify-center items-center md:flex-row md:items-stretch'}>
			...
			<article className={'space-y-4 max-w-md'}>
				<aside className={'flex flex-col items-center'}>
					<h2 className={'font-bold text-2xl text-center md:text-left w-full'}>{movie.title}</h2>
