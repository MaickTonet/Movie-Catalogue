        ...
        <CarouselContent>
          {trendingMovies.map((movie) => (
            <CarouselItem
              key={movie.id}
              className={
                "flex flex-col gap-2 items-center justify-center w-full lg:flex-row lg:max-w-[80%] lg:gap-6"
              }
            >
              <div>
                <img
              ...
              <div
                className={
                  "flex flex-col items-center max-w-[80%] lg:items-start h-full lg:py-2"
                }
              >
                <h2
                  className={
                    "font-bold text-xl text-center truncate w-full lg:text-left lg:text-2xl"
                  }
                >
                  {movie.title}
                </h2>
                ...
                <Link to={`/movie/${movie.id}`} className="mt-3 lg:mt-auto">
                  <Button
                    className={
                      "flex gap-2 items-center justify-center font-semibold text-md"
                    }
                  >
                    <Play /> Ver mais
                  </Button>
